...
public class JdbcSpitterDao extends SimpleJdbcDaoSupport implements SpitterDao {
    ...
    public List<Spittle> getRecentSpittle() {
        return getSimpleJdbcTemplate().query(SQL_SELECT_SPITTLE, new ParameterizedRowMapper<Spittle>() {
            @Override
    ...
    public void saveSpittle(Spittle spittle) {
        getSimpleJdbcTemplate().update(SQL_UPDATE_SPITTLE,
    ...
    public void addSpittle(Spittle spittle) {
        getSimpleJdbcTemplate().update(SQL_INSERT_SPITTLE,
                spittle.getSpitter().getId(),
                spittle.getText(),
                spittle.getPostedTime());
    ...
    public List<Spittle> getSpittlesByUsername(Spitter spitter) {
        return getSimpleJdbcTemplate().query(SQL_SELECT_SPITTLE_BY_USERNAME, new ParameterizedRowMapper<Spittle>() {
            @Override
            public Spittle mapRow(ResultSet rs, int rowNum) throws SQLException {
                Spittle spittle = new Spittle();
                spittle.setId(rs.getLong(1));
    ...
    public void deleteSpittle(long id) {
        getSimpleJdbcTemplate().update(SQL_DELETE_SPITTLE, id);
    }

    @Override
    public Spittle getSpittleById(long id) {
        return getSimpleJdbcTemplate().queryForObject(SQL_SELECT_SPITTLE_BY_ID, new ParameterizedRowMapper<Spittle>() {
            @Override
            public Spittle mapRow(ResultSet rs, int rowNum) throws SQLException {
                Spittle spittle = new Spittle();
                spittle.setId(rs.getLong(1));
